...
#=============
#cl = LineClient()
cl = LineClient(authToken='محل گزاشتن  توکن')
...
#ki = LineClient()
ki = LineClient(authToken='محل گزاشتن  توکن')
...
#kk = LineClient()
kk = LineClient(authToken='محل گزاشتن  توکن')
...
#kc = LineClient()
kc = LineClient(authToken='محل گزاشتن  توکن')
...
#km = LineClient()
km = LineClient(authToken='محل گزاشتن  توکن')
...
#kb = LineClient()
kb = LineClient(authToken='محل گزاشتن  توکن')
...
#sw = LineClient()
sw = LineClient(authToken='محل گزاشتن  توکن')
